...
export async function JewellersBrowseShell({
  children,
}: {
  ...
  return (
    <div>
      <section className="relative mx-0 h-[210px] overflow-hidden rounded-b-2xl md:h-[260px]">
        <Image
          src={HERO_IMAGE}
          alt="Jewellers Hub — Gold HUID verification India"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container relative flex h-full flex-col justify-end pb-6">
          ...
          <h1 className="font-display text-2xl font-bold tracking-tight md:text-4xl">
            Jewellers <span className="text-amber-400">Hub</span>
          </h1>
          <p className="mt-1 max-w-xl text-xs text-muted-foreground md:text-sm">
            HUID verify, gold rates, hallmark guide & BIS tools — trusted by jewellers
            and buyers across India
          </p>
        </div>
      </section>
