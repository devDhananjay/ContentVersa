...
const MODULES: ModuleCard[] = [
  ...
  },
  {
    name: "India Guides",
    href: "/guides",
    tagline: "Search formats",
    description: "Trends, schemes, jobs, cricket, AI tools and OTT explainers.",
    group: "read",
    icon: BookOpen,
    color: "#a78bfa",
    ...
    links: [
      ...
      { label: "Trending", href: "/guides/trending" },
      { label: "Jobs guides", href: "/guides/jobs" },
    ],
  },
  {
    name: "MoneyVerse",
