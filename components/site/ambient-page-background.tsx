...
export function AmbientPageBackground({ className }: { className?: string }) {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[min(1200px,100%)] h-[min(900px,120vh)] bg-gradient-to-br from-neon-blue/20 via-neon-purple/20 to-neon-pink/20 blur-3xl opacity-50 rounded-full" />
