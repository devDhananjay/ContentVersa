...
const STATIC_PAGES: Array<{
  ...
  { path: "/tools/ifsc-finder", changeFrequency: "weekly", priority: 0.86 },
  { path: "/tools/pincode-finder", changeFrequency: "weekly", priority: 0.86 },
  { path: "/tools/rto-finder", changeFrequency: "weekly", priority: 0.85 },
  { path: "/tools/vehicle-plate-decoder", changeFrequency: "weekly", priority: 0.85 },
  { path: "/tools/pan-gstin-checker", changeFrequency: "weekly", priority: 0.84 },
  { path: "/tools/emi-calculator", changeFrequency: "monthly", priority: 0.84 },
  { path: "/tools/sip-calculator", changeFrequency: "monthly", priority: 0.84 },
  { path: "/tools/fuel-price", changeFrequency: "daily", priority: 0.87 },
