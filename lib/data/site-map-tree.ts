...
export type SiteMapModule = {
  id: string;
  label: string;
  color: "rose" | "violet" | "sky" | "amber" | "emerald" | "orange" | "fuchsia" | "slate" | "red";
  href?: string;
  tag?: string;
  summary: string;
  groups: SiteMapGroup[];
...
export const SITE_MAP_MODULES: SiteMapModule[] = [
  {
    id: "home",
    label: "Home",
    color: "rose",
    href: "/",
    summary: "Landing page — discovery, trending content & live widgets",
    groups: [
      {
        heading: "Page sections",
        items: [
          {
            label: "Hero & featured stories",
            href: "/",
            detail: "Editor picks and latest published articles",
          },
          {
            label: "Trending & popular",
            href: "/blogs",
            detail: "Most-read blogs in the last 7 days",
          },
          {
            label: "Category highlights",
            href: "/categories",
            detail: "Quick entry into 21+ topics",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            label: "Sports ticker",
            href: "/sports",
            detail: "Live cricket scores on homepage",
          },
          {
            label: "Reels carousel",
            href: "/reels",
            detail: "Short-form preview cards",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    color: "sky",
    href: "/blogs",
    summary: "Discover, read and interact with long-form content",
    groups: [
      {
        heading: "Browse",
        items: [
          { label: "Explore all blogs", href: "/blogs", detail: "Filter by latest, trending, editor picks" },
          { label: "Categories", href: "/categories", detail: "Technology, AI, lifestyle, sports & more" },
          { label: "Category page", href: "/category/technology", detail: "Subscribe to category updates" },
          { label: "Bookmarks", href: "/bookmarks", detail: "Saved articles across devices" },
          { label: "Leaderboard", href: "/leaderboard", detail: "Top creators & active readers" },
        ],
      },
      {
        heading: "Article experience",
        items: [
          {
            label: "Blog post page",
            href: "/blogs",
            detail: "Full article with cover, author & related reads",
            children: [
              ...
              { label: "Related recommendations", detail: "Similar articles for you" },
            ],
          },
          { label: "Author profile", href: "/leaderboard", detail: "Follow creators, view their posts" },
          { label: "Polls & quizzes", detail: "Interactive content on articles" },
        ],
      },
    ],
  },
  {
    ...
    color: "violet",
    href: "/dashboard",
    summary: "Write, publish, monetize and grow your audience",
    groups: [
      {
        heading: "Studio",
        items: [
          { label: "Dashboard home", href: "/dashboard", detail: "Overview, streaks, quick actions" },
          {
            label: "Write article",
            href: "/dashboard/create",
            detail: "Rich text editor with cover image",
            children: [
      ...
      {
        heading: "Growth & money",
        items: [
          { label: "Analytics", href: "/dashboard/analytics", detail: "Views, engagement & traffic sources" },
          { label: "Earnings", href: "/dashboard/earnings", detail: "Tips received & wallet balance" },
          { label: "Withdraw", href: "/dashboard/earnings", detail: "Request payout to bank/UPI" },
          { label: "Achievements", href: "/dashboard/achievements", detail: "Badges for milestones" },
          { label: "Referral program", href: "/dashboard", detail: "Invite friends, earn rewards" },
        ],
      },
      {
        heading: "Programs",
        items: [
          ...
          },
          {
            label: "Premium",
            href: "/premium",
            detail: "Creator plan ₹199/mo · Reader ₹199/mo",
            children: [
              { label: "Priority review", detail: "Faster moderation queue" },
              { label: "Enhanced analytics", detail: "30-day deep stats" },
              { label: "Paid posts", detail: "Subscriber-only articles" },
            ],
          },
        ],
      },
      {
        heading: "Alerts",
        items: [
          { label: "Notifications", href: "/dashboard/notifications", detail: "Likes, comments, follows, tips" },
          { label: "Push notifications", href: "/dashboard/settings", detail: "Browser & mobile alerts" },
          { label: "Weekly digest email", detail: "Personalized article picks" },
        ],
      },
    ],
  },
  {
    ...
    color: "fuchsia",
    href: "/reels",
    summary: "Short vertical video & image posts",
    groups: [
      {
        heading: "Consumer",
        items: [
          { label: "Reels feed", href: "/reels", detail: "Infinite scroll shorts" },
          { label: "Reel detail", href: "/reels", detail: "Full-screen view with caption" },
          { label: "Like & comment", detail: "Engage with creators" },
          { label: "View count", detail: "Tracked per reel" },
        ],
      },
      {
        heading: "Creator tools",
        items: [
          { label: "My reels", href: "/dashboard/reels", detail: "Manage all your shorts" },
          { label: "Create reel", href: "/dashboard/reels/create", detail: "Upload video or image" },
          { label: "Edit reel", href: "/dashboard/reels", detail: "Update caption & thumbnail" },
          { label: "Moderation queue", detail: "Pending approval before publish" },
        ],
      },
    ],
  },
  {
    ...
    color: "emerald",
    href: "/sports",
    summary: "Cricket scores, news, teams & live match centre",
    groups: [
      {
        heading: "Live",
        items: [
          { label: "Sports home", href: "/sports", detail: "Live, upcoming & recent matches" },
          {
            label: "Match centre",
            href: "/sports",
            detail: "Ball-by-ball scorecard",
            children: [
              { label: "Live commentary", detail: "Over-by-over updates" },
              { label: "Scorecard", detail: "Batting & bowling stats" },
              { label: "Match reminders", detail: "Push alert 30 min before start" },
            ],
          },
        ],
      },
      {
        heading: "Browse",
        items: [
          { label: "Teams", href: "/sports/teams", detail: "International & domestic squads" },
          { label: "Team profile", href: "/sports/teams", detail: "Squad, stats & fixtures" },
          { label: "Players", href: "/sports/players", detail: "Search & trending players" },
          { label: "Player profile", href: "/sports/players", detail: "Career stats & recent form" },
          { label: "Series & tournaments", href: "/sports", detail: "Points table, schedule & squads" },
          { label: "Cricket news", href: "/sports", detail: "Latest stories & match reports" },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        heading: "Markets",
        items: [
          { label: "Finance hub", href: "/finance", detail: "Nifty 50, Sensex overview" },
          { label: "Top gainers", href: "/finance", detail: "Best performers today" },
          { label: "Top losers", href: "/finance", detail: "Biggest declines today" },
          { label: "Top 10 stocks", href: "/finance", detail: "Most tracked symbols" },
          {
            label: "Stock detail page",
            href: "/finance",
            detail: "Price, chart & company info",
            children: [
              { label: "3-month price chart", detail: "Daily OHLC data" },
      ...
      },
      {
        ...
        items: [
          { label: "Gold Price Today", href: "/goldverse", detail: "22K & 24K rates + HUID" },
          { label: "Silver Price Today", href: "/guides/money/silver-rate-today-india-cities", detail: "Chandi rate India" },
          { label: "SIP", href: "/guides/money/sip-calculator-india-beginners-guide", detail: "Systematic investment plans" },
          { label: "Mutual Funds", href: "/guides/money/sip-calculator-india-beginners-guide", detail: "Equity SIP basics" },
          { label: "Stocks", href: "/finance/stocks", detail: "Share market basics" },
          { label: "IPO", href: "/finance/ipo", detail: "IPO apply & allotment basics" },
          { label: "FD", href: "/guides/money/fd-vs-rd-india-guide", detail: "Fixed deposit + calculator" },
          { label: "RD", href: "/guides/money/fd-vs-rd-india-guide", detail: "Recurring deposit + calculator" },
          { label: "Loans", href: "/guides/money/emi-calculator-india-guide", detail: "EMI & borrowing basics" },
          { label: "Credit Cards", href: "/guides/money/credit-card-minimum-due-india", detail: "Bills & smart habits" },
          { label: "Credit Score", href: "/guides/money/credit-score-cibil-india-guide", detail: "CIBIL basics" },
          { label: "Tax", href: "/guides/money/salary-tax-calculator-india-guide", detail: "Salary tax & GST tools" },
        ],
      },
      {
        ...
        items: [
          {
            ...
            href: "/finance",
            detail: "Add/remove NSE stocks",
            children: [
              { label: "Market open email", detail: "All watchlist stocks in one mail" },
              { label: "Market close email", detail: "Close price + % change" },
              { label: "Top 5 gainers & losers", detail: "Nifty 50 movers in same email" },
              { label: "Push + in-app alerts", detail: "Per-stock notifications" },
            ],
          },
  ...
  },
  {
    ...
    color: "orange",
    href: "/jobs",
    summary: "Government and private sector job listings for India",
    groups: [
      {
        heading: "Listings",
        items: [
          { label: "Jobs home", href: "/jobs", detail: "All categories in one place" },
          { label: "Government jobs", href: "/jobs/govt", detail: "Sarkari naukri, exams & results" },
          { label: "Private jobs", href: "/jobs/private", detail: "Tech, startup & corporate roles" },
        ],
      },
      {
        heading: "Features",
        items: [
          { label: "Filter by category", detail: "Location, sector & type" },
          { label: "External apply links", detail: "Redirect to official portals" },
          { label: "Daily sync", detail: "Fresh listings via cron" },
        ],
      },
    ],
  },
  {
    ...
    label: "Account",
    color: "slate",
    summary: "Authentication, profile & personal settings",
    groups: [
      {
        heading: "Auth",
        items: [
          { label: "Sign in", href: "/auth/sign-in", detail: "Email + password or Google OAuth" },
          { label: "Sign up", href: "/auth/sign-up", detail: "Create free creator account" },
          { label: "Sign out", detail: "Clear session & cookies" },
        ],
      },
      {
        heading: "Profile",
        items: [
          { label: "Public profile", href: "/leaderboard", detail: "Username, avatar, bio & posts" },
          { label: "Follow creators", detail: "Feed from people you follow" },
          { label: "Settings", href: "/dashboard/settings", detail: "Profile, notifications, theme" },
          { label: "Reading challenges", href: "/dashboard", detail: "Daily goals & streaks" },
        ],
      },
    ],
  },
...
export const SITE_MAP_ADMIN: SiteMapModule = {
  id: "admin",
  label: "Admin Panel",
  color: "red",
  tag: "Staff only",
  href: "/admin",
  summary:
    "Secure back-office for MODERATOR, ADMIN & SUPER_ADMIN roles — sidebar navigation, pending badges & platform controls",
  groups: [
    {
      heading: "Access & layout",
      items: [
        {
          label: "Role-gated entry",
          href: "/admin",
          detail: "Redirects to sign-in or dashboard if not admin",
          children: [
            { label: "MODERATOR", detail: "Content review access" },
            { label: "ADMIN", detail: "Full platform management" },
            { label: "SUPER_ADMIN", detail: "User promotion & password reset" },
          ],
        },
        {
          label: "Admin sidebar",
          detail: "Sticky left nav with live pending badges",
          children: [
            { label: "Approve blogs badge", detail: "Count of PENDING submissions" },
            { label: "Approve reels badge", detail: "Count of pending shorts" },
            { label: "Creator dashboard link", detail: "Switch back to writer studio" },
          ],
        },
        {
          label: "Admin View banner",
          detail: "Top strip when browsing site as admin",
        },
        {
          label: "Admin View button",
          detail: "Quick entry from main navbar or profile menu",
        },
      ],
    },
    {
      ...
      items: [
        {
          label: "Admin home",
          href: "/admin",
          detail: "Platform overview at a glance",
          children: [
            { label: "Total users stat", href: "/admin/users", detail: "Registered accounts" },
            { label: "Published blogs stat", href: "/admin/blogs", detail: "Live articles count" },
            { label: "Pending review stat", detail: "Awaiting moderation" },
            { label: "Drafts stat", detail: "Unpublished creator drafts" },
            { label: "Pending moderation list", detail: "Preview + quick open each blog" },
            { label: "Quick links panel", detail: "Shortcuts to every admin tool" },
          ],
        },
        {
          label: "Admin account",
          href: "/admin/account",
          detail: "Your staff profile & session info",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          detail: "Review creator submissions before they go live",
          children: [
            { label: "PENDING queue", detail: "New posts waiting for human review" },
            { label: "Approve & publish", detail: "Sets status PUBLISHED + notifies author" },
            { label: "Reject with reason", detail: "Sends feedback to creator" },
            { label: "Request edits", detail: "Return to author for changes" },
          ],
        },
        {
          label: "Approve reels",
          href: "/admin/reels-moderation",
          detail: "Review short video & image reels",
          children: [
            { label: "Pending reels queue", detail: "Badge count in sidebar" },
            { label: "Approve / reject", detail: "Controls public reels feed visibility" },
          ],
        },
        {
          label: "User reports",
          href: "/admin/reports",
          detail: "Community-flagged content & abuse cases",
          children: [
            { label: "Open reports list", detail: "Submitted via report button" },
            { label: "Resolve or dismiss", detail: "Mark report handled" },
          ],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          detail: "Manage topic taxonomy & metadata",
          children: [
            { label: "Slug, name, description", detail: "21+ editorial categories" },
            { label: "Icons & banner images", detail: "Category page branding" },
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          href: "/admin/meta-publishing",
          detail: "Cross-post blogs & reels to Facebook + Instagram",
          children: [
            { label: "OAuth connect", detail: "Facebook Login + Page token" },
            { label: "Manual Page token", detail: "META_PAGE_ID env fallback" },
            { label: "Publish blog link", detail: "Share article to connected Page" },
            { label: "Publish reel", detail: "Push short video to Instagram" },
            { label: "Publish history log", detail: "Permalinks & error tracking" },
          ],
        },
      ],
    },
      ...
      items: [
        {
          label: "All users",
          href: "/admin/users",
          detail: "Search profiles, emails & post counts",
          children: [
            { label: "Filter by role", detail: "USER · VERIFIED_CREATOR · MODERATOR · ADMIN" },
            { label: "Sort by activity", detail: "Recent signups & top creators" },
          ],
        },
        {
          label: "User detail",
          href: "/admin/users",
          detail: "Deep profile view per account",
          children: [
            { label: "Blog breakdown", detail: "Published / pending / draft / rejected" },
            { label: "Follower & view stats", detail: "Creator performance snapshot" },
            { label: "Change password", detail: "SUPER_ADMIN only" },
            { label: "Promote to admin", detail: "Elevate MODERATOR / ADMIN roles" },
          ],
        },
      ],
    },
    {
      heading: "Analytics & revenue",
      items: [
        {
          label: "Analytics",
          href: "/admin/analytics",
          detail: "Platform-wide traffic & engagement",
          children: [
            { label: "Page views trend", detail: "Daily / weekly charts" },
            { label: "Top articles", detail: "Most read content" },
            { label: "User growth", detail: "Signups over time" },
          ],
        },
        {
          label: "Revenue",
          href: "/admin/revenue",
          detail: "Monetization dashboard",
          children: [
            { label: "MRR & ARR", detail: "Monthly / annual recurring revenue" },
            { label: "Tips volume", detail: "Creator tip transactions in ₹" },
            { label: "Ad & premium breakdown", detail: "Revenue by source chart" },
            { label: "Payout controls", detail: "Creator withdrawal settings" },
          ],
        },
      ],
    },
    {
      heading: "CMS & platform settings",
      items: [
        {
          label: "Admin settings",
          href: "/admin/settings",
          detail: "Site identity, homepage & push configuration",
          children: [
            { label: "Branding assets", detail: "Upload logo & favicon to S3" },
            { label: "Firebase push setup", detail: "VAPID key & credentials sync" },
            { label: "Site title & tagline", detail: "Global SEO defaults" },
            { label: "Homepage sections toggle", detail: "Hero, trending, newsletter, etc." },
            { label: "Trending logic", detail: "Likes threshold & refresh interval" },
            { label: "Announcement banner", detail: "Site-wide alert message" },
          ],
        },
        {
          label: "Static pages CMS",
          detail: "About, Premium, Terms, Privacy editable in DB",
          children: [
            { label: "Premium pricing copy", href: "/premium", detail: "Creator ₹199/mo · Reader ₹199/mo" },
            { label: "Legal pages", href: "/terms", detail: "Terms, privacy, cookies, policy" },
          ],
        },
        {
...
export const SITE_MAP_FOOTER = {
  label: "Footer",
  summary: "Global footer on every page — links, legal & visitor count",
  columns: [
    {
      heading: "Platform",
      items: [
