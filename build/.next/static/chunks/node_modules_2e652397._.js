    ...
    const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openDB"])(OLD_DB_NAME, OLD_DB_VERSION, {
        upgrade: async (db, oldVersion, newVersion, upgradeTransaction)=>{
            ...
            if (oldVersion === 2) {
                ...
                var _oldDetails_createTime;
                tokenDetails = {
                    token: oldDetails.fcmToken,
                    createTime: (_oldDetails_createTime = oldDetails.createTime) !== null && _oldDetails_createTime !== void 0 ? _oldDetails_createTime : Date.now(),
                    subscriptionOptions: {
...
function propagateFcmOptions(payload, messagePayloadInternal) {
    var _messagePayloadInternal_notification, _messagePayloadInternal_fcmOptions, _messagePayloadInternal_notification1, _messagePayloadInternal_fcmOptions1;
    // fcmOptions.link value is written into notification.click_action. see more in b/232072111
    if (!messagePayloadInternal.fcmOptions && !((_messagePayloadInternal_notification = messagePayloadInternal.notification) === null || _messagePayloadInternal_notification === void 0 ? void 0 : _messagePayloadInternal_notification.click_action)) {
        return;
    }
    payload.fcmOptions = {};
    var _messagePayloadInternal_fcmOptions_link;
    const link = (_messagePayloadInternal_fcmOptions_link = (_messagePayloadInternal_fcmOptions = messagePayloadInternal.fcmOptions) === null || _messagePayloadInternal_fcmOptions === void 0 ? void 0 : _messagePayloadInternal_fcmOptions.link) !== null && _messagePayloadInternal_fcmOptions_link !== void 0 ? _messagePayloadInternal_fcmOptions_link : (_messagePayloadInternal_notification1 = messagePayloadInternal.notification) === null || _messagePayloadInternal_notification1 === void 0 ? void 0 : _messagePayloadInternal_notification1.click_action;
    if (!!link) {
        payload.fcmOptions.link = link;
    }
    // eslint-disable-next-line camelcase
    const analyticsLabel = (_messagePayloadInternal_fcmOptions1 = messagePayloadInternal.fcmOptions) === null || _messagePayloadInternal_fcmOptions1 === void 0 ? void 0 : _messagePayloadInternal_fcmOptions1.analytics_label;
    if (!!analyticsLabel) {
    ...
    return new Promise((resolve, reject)=>{
        ...
        if (registration.active) {
            ...
            incomingSw.onstatechange = (ev)=>{
                var _ev_target;
                if (((_ev_target = ev.target) === null || _ev_target === void 0 ? void 0 : _ev_target.state) === 'activated') {
...
__turbopack_context__.s([
    "deleteToken",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteToken"],
    "getMessaging",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessaging"],
    "getToken",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToken"],
    "isSupported",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSupported"],
    "onMessage",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onMessage"]
]);
...
//# sourceMappingURL=node_modules_2e652397._.js.map