...
<body style="margin:0;padding:0;background:#0a0a0f;font-family:system-ui,-apple-system,sans-serif;color:#e4e4e7;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:0 auto;padding:32px 20px;">
    ...
    ${f(b+"/dashboard","Open dashboard")}`)}}function j(a){let b=(0,d.X)(),c=a.items.map(a=>`<li style="margin-bottom:14px;">
          ...
          <a href="${b}/blog/${a.slug}" style="color:#fff;font-weight:600;text-decoration:none;font-size:16px;">${s(a.title)}</a>
        </li>`).join("");return{subject:"ContentVerse morning briefing",html:e(`<h1 style="margin:0 0 8px;font-size:22px;color:#fff;">Your morning briefing</h1>
    <p style="margin:0 0 20px;color:#a1a1aa;font-size:14px;">Sports \xb7 Finance \xb7 Jobs picks for today</p>
    <ul style="margin:0;padding:0;list-style:none;">${c}</ul>
    ${f(b+"/blogs","Open ContentVerse")}`,`<p><a href="${a.unsubscribeUrl}" style="color:#71717a;">Unsubscribe</a></p>`)}}function k(a){let b=(0,d.X)(),c=a.movies.map(a=>`<li style="margin-bottom:14px;">
