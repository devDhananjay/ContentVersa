...
<body style="margin:0;padding:0;background:#0a0a0f;font-family:system-ui,-apple-system,sans-serif;color:#e4e4e7;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:0 auto;padding:32px 20px;">
    ...
    ${f(b+"/blogs","Browse articles")}`,`<p><a href="${a}" style="color:#71717a;">Unsubscribe</a></p>`)}}function h(a){let b=(0,d.X)(),c=a.articles.map(a=>{var c;return`<li style="margin-bottom:16px;">
          ...
          <a href="${b}/blog/${a.slug}" style="color:#fff;font-weight:600;text-decoration:none;font-size:16px;">${s(a.title)}</a>
          ${a.excerpt?`<p style="margin:6px 0 0;color:#a1a1aa;font-size:14px;line-height:1.5;">${s(a.excerpt.slice(0,120))}${a.excerpt.length>120?"…":""}</p>`:""}
    ...
    ${f(b+"/blogs","See all articles")}`,`<p><a href="${a.unsubscribeUrl}" style="color:#71717a;">Unsubscribe</a></p>`)}}function i(a){let b=(0,d.X)(),c=a.name?`Hey ${s(a.name.split(" ")[0])}`:"Hey creator",g=a.topComment?`<div style="margin-top:20px;padding:16px;background:#09090b;border-radius:12px;border:1px solid #27272a;">
        ...
        <p style="margin:0 0 8px;color:#e4e4e7;font-size:15px;line-height:1.5;">“${s(a.topComment.content.slice(0,180))}${a.topComment.content.length>180?"…":""}”</p>
        <a href="${b}/blog/${a.topComment.blogSlug}" style="color:#a1a1aa;font-size:13px;text-decoration:none;">on ${s(a.topComment.blogTitle)}</a>
    ...
    ${f(b+"/dashboard","Open dashboard")}`)}}function j(a){let b=(0,d.X)(),c=a.items.map(a=>`<li style="margin-bottom:14px;">
          <span style="display:block;font-size:11px;color:#22d3ee;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:4px;">${s(a.hub)}</span>
          <a href="${b}/blog/${a.slug}" style="color:#fff;font-weight:600;text-decoration:none;font-size:16px;">${s(a.title)}</a>
    ...
    ${f(b+"/blogs","Open ContentVerse India")}`,`<p><a href="${a.unsubscribeUrl}" style="color:#71717a;">Unsubscribe</a></p>`)}}function k(a){let b=(0,d.X)(),c=a.movies.map(a=>`<li style="margin-bottom:14px;">
          <a href="${b}${a.href}" style="color:#fff;font-weight:600;text-decoration:none;font-size:16px;">${s(a.title)}</a>
          ${a.releaseDate?`<span style="display:block;font-size:12px;color:#a1a1aa;margin-top:4px;">Release: ${s(a.releaseDate)}</span>`:""}
    ...
    <p style="margin:0 0 8px;font-size:18px;font-weight:600;color:#fff;">${s(a.title)}</p>
    ${a.excerpt?`<p style="margin:0 0 16px;color:#a1a1aa;line-height:1.6;">${s(a.excerpt.slice(0,200))}</p>`:""}
    ...
    ${b.map(b=>{let c=`${a}/finance/stock/${encodeURIComponent(b.symbol)}`,e=b.price.toLocaleString("en-IN",{maximumFractionDigits:2});return`<li style="margin-bottom:12px;padding-bottom:12px;border-bottom:1px solid #27272a;">
          <a href="${c}" style="color:#fff;font-weight:600;text-decoration:none;font-size:15px;">${s(b.symbol)}</a>
          <span style="display:block;margin-top:4px;color:#a1a1aa;font-size:13px;">${s(b.name)}</span>
          ...
          <a href="${c}" style="color:#fff;font-weight:600;text-decoration:none;font-size:16px;">${s(a.title)}</a>
          <p style="margin:6px 0 0;color:#a1a1aa;font-size:14px;line-height:1.5;">${s(a.message)}</p>
    ...
    <p style="margin:0 0 16px;line-height:1.65;color:#d4d4d8;">${s(g.body)}</p>
    ${f(g.href,g.cta)}
